...
SQMFiles = ['20181005_192507_TelescopeSQM.dat','20181005_192533_ZenithSQM.dat']
#Boltwoodfile = 'Boltwood_2018-10-05.txt'
filefilter = '*v.fts'
...
def SortDataFilesChronologically():
...
def main():
    ...
    SortedDataFiles = SortDataFilesChronologically()
    print('Files sorted.\n')
